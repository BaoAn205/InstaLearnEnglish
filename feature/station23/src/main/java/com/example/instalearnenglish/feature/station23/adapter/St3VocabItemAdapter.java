...
public class St3VocabItemAdapter extends RecyclerView.Adapter<St3VocabItemAdapter.ViewHolder> {
    ...
    public St3VocabItemAdapter(List<St23VocabItem> items, OnItemClickListener listener) {
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.st3_vocab_item, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            imageView = view.findViewById(R.id.st3_iv_vocab_image);
            textView = view.findViewById(R.id.st3_tv_vocab_name);
        }
        ...
        void bind(final St23VocabItem item, final OnItemClickListener listener) {
            ...
            String transitionName = "st3_vocab_image_" + item.getName();
