...
public class St3VocabCardAdapter extends RecyclerView.Adapter<St3VocabCardAdapter.VocabViewHolder> {

    private final List<St23Vocabulary> vocabList;

    public St3VocabCardAdapter(List<St23Vocabulary> vocabList) {
    ...
    public VocabViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.st3_flashcard_container, parent, false);
    ...
    static class VocabViewHolder extends RecyclerView.ViewHolder {
        ...
        public VocabViewHolder(@NonNull View itemView) {
            super(itemView);
            cardFlipperContainer = itemView.findViewById(R.id.st3_card_flipper_container);
            flashcardFront = itemView.findViewById(R.id.st3_flashcard_front);
            flashcardBack = itemView.findViewById(R.id.st3_flashcard_back);
            
            word = flashcardFront.findViewById(R.id.st3_flashcard_word);
            pronunciation = flashcardBack.findViewById(R.id.st3_flashcard_pronunciation);
            meaning = flashcardBack.findViewById(R.id.st3_flashcard_meaning);
            image = flashcardBack.findViewById(R.id.st3_flashcard_image);
        }
