...
public class St3TravelTipFragment extends Fragment implements TravelTipAdapter.OnTipInteractionListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.st3_fragment_travel_tip, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.st3_tip_recycler_view);
        pageIndicator = view.findViewById(R.id.st3_tip_page_indicator);
