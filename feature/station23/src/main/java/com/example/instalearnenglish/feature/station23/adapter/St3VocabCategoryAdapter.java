...
public class St3VocabCategoryAdapter extends RecyclerView.Adapter<St3VocabCategoryAdapter.ViewHolder> {

    private final List<St23VocabCategory> categories;
    private final St3VocabItemAdapter.OnItemClickListener itemClickListener;
    private final ViewPager2 parentViewPager;

    public St3VocabCategoryAdapter(List<St23VocabCategory> categories, St3VocabItemAdapter.OnItemClickListener itemClickListener, ViewPager2 parentViewPager) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.st3_vocab_category_item, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            tvCategoryTitle = view.findViewById(R.id.st3_tv_category_title);
            rvVocabItems = view.findViewById(R.id.st3_rv_vocab_items);
        }

        void bind(St23VocabCategory category, St3VocabItemAdapter.OnItemClickListener itemClickListener, final ViewPager2 parentViewPager) {
            ...
            St3VocabItemAdapter itemAdapter = new St3VocabItemAdapter(category.getItems(), itemClickListener);
