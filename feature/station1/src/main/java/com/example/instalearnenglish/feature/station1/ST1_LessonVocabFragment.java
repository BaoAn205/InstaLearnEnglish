...
import com.example.instalearnenglish.feature.station1.adapter.VocabCategoryAdapter;
import com.example.instalearnenglish.feature.station1.model.VocabCategory;
import com.example.instalearnenglish.feature.station1.model.VocabItem;
...
public class ST1_LessonVocabFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        VocabCategoryAdapter categoryAdapter = new VocabCategoryAdapter(categoryList, (item, sharedImageView) -> {
            Intent intent = new Intent(getActivity(), ST1_VocabDetailActivity.class);
            intent.putExtra(ST1_VocabDetailActivity.EXTRA_NAME, item.getName());
            intent.putExtra(ST1_VocabDetailActivity.EXTRA_PHONETIC, item.getPhonetic());
            intent.putExtra(ST1_VocabDetailActivity.EXTRA_IMAGE_RES_ID, item.getImageResId());
            intent.putExtra(ST1_VocabDetailActivity.EXTRA_VIETNAMESE, item.getVietnameseMeaning());
            intent.putExtra(ST1_VocabDetailActivity.EXTRA_EXAMPLE, item.getExampleSentence());
