...
public class ST4_GameHistoryAdapter extends RecyclerView.Adapter<ST4_GameHistoryAdapter.ViewHolder> {

    private final JSONArray historyArray;

    public ST4_GameHistoryAdapter(JSONArray historyArray) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.st4_item_game_history, parent, false);
