...
public class ST4_VocabDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.st4_activity_vocab_detail);
    ...
    private void archiveVocab() {
        ...
        db.collection("users").document(user.getUid()).collection("archived_vocabs")
                .document(vocabName)
                .set(vocabData)
                .addOnSuccessListener(aVoid -> Toast.makeText(ST4_VocabDetailActivity.this, "Saved to Archive!", Toast.LENGTH_SHORT).show())
                .addOnFailureListener(e -> Toast.makeText(ST4_VocabDetailActivity.this, "Failed to save.", Toast.LENGTH_SHORT).show());
    }
