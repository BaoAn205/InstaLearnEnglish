...
public class ST4_LessonSimulationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (lessonId != null && !currentStepId.isEmpty()) {
            ...
            Log.e("Simulation", "Missing lessonId or currentStepId");
        }
    }
    ...
    private void loadStep(String stepId) {
        ...
        Log.d("Simulation", "Loading lesson: " + lessonId + ", step: " + stepId);
        ...
        db.collection("journey_content").document(lessonId)
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    if (documentSnapshot.exists()) {
                        Log.d("Simulation", "Data found: " + documentSnapshot.getData());
                        ST4_SimulationStep step = documentSnapshot.toObject(ST4_SimulationStep.class);
                        if (step != null) {
                            displayStep(step);
                        } else {
                            Log.e("Simulation", "Failed to parse SimulationStep model");
                        }
                    } else {
                        Log.e("Simulation", "No data found for this step in Firestore!");
                        addBotMessage("Sorry, no content available for this station yet.", false);
                    }
                })
                .addOnFailureListener(e -> {
                    Log.e("Simulation", "Firestore Error: " + e.getMessage());
                });
    }
