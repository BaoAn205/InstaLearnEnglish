...
public class ST5_VocabDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.st5_activity_vocab_detail);
    ...
    private void archiveVocab() {
        ...
        vocabData.put("station", 5);

        db.collection("users").document(user.getUid()).collection("archived_vocabs")
                .document(vocabName)
                .set(vocabData)
                .addOnSuccessListener(aVoid -> Toast.makeText(ST5_VocabDetailActivity.this, "Saved to Archive!", Toast.LENGTH_SHORT).show())
                .addOnFailureListener(e -> Toast.makeText(ST5_VocabDetailActivity.this, "Failed to save.", Toast.LENGTH_SHORT).show());
    }
