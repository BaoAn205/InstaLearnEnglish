...
public class ST5_TipsPagerAdapter extends RecyclerView.Adapter<ST5_TipsPagerAdapter.ViewHolder> {
    ...
    public ST5_TipsPagerAdapter(List<Tip> tips, TextToSpeech tts) {
        this.tips = tips;
        this.tts = tts;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.st5_tip_pager_item, parent, false);
