...
public class ST5_VocabCardAdapter extends RecyclerView.Adapter<ST5_VocabCardAdapter.VocabViewHolder> {

    private final List<ST5_Vocabulary> vocabList;

    public ST5_VocabCardAdapter(List<ST5_Vocabulary> vocabList) {
    ...
    public VocabViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.st5_flashcard_container, parent, false);
    ...
    static class VocabViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(ST5_Vocabulary vocab) {
        ...
        private void flipCard() {
            // Sửa lại tên animator cho khớp với file trong res/animator
